...
public class Student503InfoService implements Service<StudentManagement>, Retrivable<SearchStudent, StudentManagement>{

    private final StudentManagementMapper mapper;

    public Student503InfoService(StudentManagementMapper mapper) {
        this.mapper = mapper;
    }
