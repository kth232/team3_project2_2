...
public class StudentManagementControllerLocator extends AbstractControllerLocator {
    ...
    public Controller find(Menu menu) {
        ...
        if(menu instanceof StSMMenu){
            ...
            switch(stsmMenu) {
                case LISTSTUDENT502 : controller = new Select502StudentController(); break; // 502호 선택하기
                case LISTSTUDENT503 : controller = new Select503StudentController(); break; // 503호 선택하기
