...
public class AddLectureController extends AbstractController {
    ...
    public void show() {
        //기본 출력 화면=서브메인
        Templates.getInstance().render(LectureMenu.ADDLECTURE);
    }
    ...
    public void prompt() {
        ...
        * */
        ...
        try {
            //학급 추가 처리
            //기능 부분은 AddLectureService와 연동
            Service service = LectureServiceLocator.getInstance().find(LectureMenu.ADDLECTURE);
